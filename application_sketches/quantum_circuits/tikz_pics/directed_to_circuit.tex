\begin{tikzpicture}[scale=0.35,thick] % , baseline = -3.5pt
    ...
    \begin{scope}
        ...
        \node[anchor=center] (text) at (5.65,6.5) {$\qcbencodingof{\condprobof{\catvariableof{\catenumerator}=1}{\catvariableof{\parentsof{\catenumerator}}} }$};
        \draw (9,6.5) -- (10,6.5);
        ...
        \node[anchor=center] (text) at (-1,2.5) {$\catvariableof{\parentsof{\catenumerator},\insymbol}$};

        \node[anchor=center] (text) at (8,2.75) {$\vdots$};
        \node[anchor=center] (text) at (12,2.5) {$\catvariableof{\parentsof{\catenumerator},\outsymbol}$};
