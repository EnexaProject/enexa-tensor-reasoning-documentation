...
\begin{document}
    ...
    Following the schemes in [Low et al. - Quantum Inference on Bayesian Networks], we can prepare any non-negative tensors by a sequence of controlled rotations.
    ...
    \section{Representing \ComputationActivationNetworks{} as Quantum Circuits}
