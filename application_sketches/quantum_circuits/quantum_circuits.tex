...
\begin{document}
    ...
    We can produce augmented Q-samples for \ComputationActivationNetworks{} (see \defref{def:augmentedQsample}) using basis circuit encodings of the computation cores and ancilla encodings of the activation cores.
