...
UCP is \algoref{alg:contractionPropagation} is case of bethe hypergraphs (having bipartite overlap graphs with nodes to previous hyperedges and variable nodes).
