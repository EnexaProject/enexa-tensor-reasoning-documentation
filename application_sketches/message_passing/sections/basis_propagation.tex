...
\begin{example}[Function evaluation on a dataset]
    ...
    \begin{figure}
        ...
        \end{center}
        \caption{
            Behavior of the contraction propagation algorithm for the evaluation of the formula $(\catvariableof{a}\land\catvariableof{b})\lor(\catvariableof{b}\Rightarrow\catvariableof{c})$ on a datapoint $(a^{\datindex},b^{\datindex},c^{\datindex})$, which is selected from a dataset $\datamap$.
