...
%    \end{align*}
    ...
    \begin{itemize}
        ...
        \end{align*}
        Actually this is well-defined also in some situations, where the likelihood score is for all activation tensors $\infty$ (more precise, when a datapoint is not in the base measure support, but its statistic coincides with the statistic of a supported state).
    \end{itemize}
