...
\begin{document}
    ...
    Consider two variables $Z$ and $X$ with a joint distribution $\probtensorof{Z,X}$, and a function $T$ on the states of $X$.
    ...
    \begin{lemma}\label{lem:doubleDetSstat}
...
%    (See proof of Theorem 2.19 in the Report)
    ...
    \subsection{Equivalent definitions of sufficient statistics}

    \begin{theorem}[Factorization Theorem of Fisher and Neyman]\label{the:factorizationFisherNeyman}
