...
%    \end{align*}
    ...
    \begin{definition}
        ...
        \end{align*}
        Here we allow for division by $0$, where we define $\frac{0}{0}=0$ and $\frac{\lambda}{0}=sign(\lambda)\cdot\infty$ for $\lambda\neq 0$.
    \end{definition}
    ...
    \begin{example} %% CHECK WHETHER SOMETHING IS WRONG!
    ...
    \begin{align*}
        ...
        = \acttensorofat{\theta}{\headvariableof{\sstat}=\sstatat{\catindex}} \cdot \contractionof{\basemeasureat{\tilde{\catvariable}},\bencodingofat{\sstat}{\headvariableof{\sstat},\tilde{\catvariable}},\bencodingofat{\sstat}{\headvariableof{\sstat},\catvariable}}{\indexedcatvariable} \, .
    \end{align*}
