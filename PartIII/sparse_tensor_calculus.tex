...
\begin{proof}
	...
	\begin{align}\label{eq:sliceFromSliceSelector}
	  	\fselectionmapat{\shortcatvariables,\indexedselvariableof{0,0},\ldots,\indexedselvariableof{\selorder-1,0},\indexedselvariableof{0,1},\ldots,\indexedselvariableof{\selorder-1,1}} = \onehotmapofat{\catindexof{\variableset}}{\shortcatvariables} \, . 
	\end{align}
...
It follows, that the expressivity of the slice selecting neural network coincides with the set of tensors with a bound on their slice sparsity, when $\selorder\geq\atomorder$.
For arbitrary $\selorder$, the following theorem holds.
