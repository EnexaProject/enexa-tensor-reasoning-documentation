\section{Sparse Calculus}\label{cha:sparseCalculus}
...
One application is as a parametrization scheme in the approximation of a tensor by a slice-sparse tensor, see \charef{cha:tensorApproximation}.
...
\begin{align}
	\subspaceof{\exformula} = \spanof{\lnot\exformula,\exformula} %=  \mathrm{im}\left(\ftensorof{\exformula} \right)
