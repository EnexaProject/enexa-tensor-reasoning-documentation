...
\begin{definition}[Basis encoding of maps]
    ...
    \begin{align*}
        \bencodingofat{\exfunction}{\indvariableof{\insymbol},\indvariableof{\outsymbol}}
...
\begin{proof}
    ...
    \begin{align*}
        \sum_{\indindexofin{\outsymbol}} \bencodingofat{\exfunction}{\indexedindvariableof{\insymbol},\indexedindvariableof{\outsymbol}}
        =  \bencodingofat{\exfunction}{\indexedindvariableof{\insymbol},\indvariableof{\outsymbol}=\invindexinterpretationofat{\outsymbol}{\exfunctionat{\indexinterpretationofat{\insymbol}{\indindexof{\insymbol}}}}}
        = 1 \, .
    \end{align*}
...
\begin{proof}
    ...
    \begin{align*}
        \probwith = \normationof{\bencodingof{\exfunction}{\headvariable,\shortcatvariables},\onehotmapofat{\selindex}{\headvariable}}{\shortcatvariables} \, .
    \end{align*}
