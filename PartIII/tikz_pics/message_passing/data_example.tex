...
\node[anchor=center] (text) at (3,7) {\small $\concoreof{\lor}$};

\draw (2,5) rectangle (4,3);
\node[anchor=center] (text) at (3,4) {\small $\concoreof{\land}$};
...
\node[anchor=center] (text) at (3.5,6) {\small $\concoreof{\lor}$};
