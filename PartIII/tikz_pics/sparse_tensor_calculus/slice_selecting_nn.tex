...
\draw[<-] (5,-3)--(7,-3) node[midway,below] {\tiny $\selvariableof{\selorder\shortminus1,0}$}; 
\draw[<-] (5,-4.5)--(7,-4.5) node[midway,below] {\tiny $\selvariableof{\selorder\shortminus1,1}$}; 
...
\begin{scope}[shift={(17,8)}]
	...
	\begin{scope}[shift={(0,-10)}]
		...
		\node[anchor=center] (text) at (1,4) {$\rencodingof{\{\lnot,\mathrm{Id},\mathrm{T}\}}$};
		...
		% Second leg selector
		\draw (10,5) --(10,7);
		\draw[->] (10,1) -- (10,5) node[midway, right] {\tiny $\catvariableof{\lneuron_{\selorder\shortminus 1}}$};	
		\draw (8,-1) rectangle (12, 1);
		\node[anchor=center] (text) at (10,0) {$\rencodingof{\{\lnot,\mathrm{Id},\mathrm{T}\}}$};
		\draw[<-] (12,0) -- (14,0) node[midway, below] {\tiny $\selvariableof{\selorder\shortminus1,0}$};

%		\draw (9,-1) -- (9,1);
		\draw[->] (10,-3) -- (10,-1) node[midway, left] {\tiny $\catvariableof{\vselectionsymbol,1}$};
		\draw (8,-5) rectangle (12, -3);
		\node[anchor=center] (text) at (10,-4) {$\selectorcoreof{\selorder\shortminus1}$};
		\draw[<-] (12,-4) -- (14,-4) node[midway, below] {\tiny $\selvariableof{\selorder\shortminus1,1}$};
