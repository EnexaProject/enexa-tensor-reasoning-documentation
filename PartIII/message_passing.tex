...
\red{The application of message passing schemata can be justified based on commutation and monotonous properties of large contractions.
...
\sect{Basis Calculus as message passing scheme}
