...
\node[anchor=center] (text) at (-1,3) {${a)}$};
	...
	\node [circle, draw, thick, fill=gray!50] (H) at (5,0) {\tiny $\catvariableof{\node}$};
	\node [circle, draw, thick, fill=gray!50] (P1) at (0,-5) {\tiny $\catvariableof{0}$};
	\node [circle, draw, thick, fill=gray!50] (P2) at (5,-5) {\tiny $\catvariableof{1}$};
	
	\node[anchor=center] (text) at (10,-5) {$\cdots$};
	\node [circle, draw, thick, fill=gray!50] (Pd) at (15,-5) {\tiny $\catvariableof{\atomorder\shortminus1}$};
