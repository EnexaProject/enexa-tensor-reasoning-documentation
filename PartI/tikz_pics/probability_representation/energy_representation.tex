\begin{tikzpicture}[scale=0.35,thick] % , baseline = -3.5pt
    ...
    \begin{scope}
        ...
        \node[anchor=center] (text) at (2,2.5) {\small $\contractionof{\expof{\contractionof{\sencsstat,\canparam}{\shortcatvariables},\basemeasureat{\shortcatvariables}}}{\shortcatvariables}$};
