...
\node[anchor=center] (text) at (2.5,0) {\small $\probat{\exrandom,\secexrandom,\thirdexrandom}$};
...
\node[anchor=center] (text) at (23,0) {\small $\probat{\thirdexrandom}$};
\draw (23,-1) -- (23,-3) node[midway, left] {\tiny $\thirdexrandom$};

\draw (23,-3) -- (23,-5);
\draw[fill] (23,-5) circle (0.15cm);
