...
\node[anchor=center] (text) at (-1,3) {${a)}$};
	...
	\node [circle, draw, thick, fill=gray!50] (T2) at (5,0) {\tiny $\catvariableof{1}$};
	\draw[->-] (T1) -- (T2);
	\node [circle, draw, thick, fill=gray!50] (T3) at (10,0) {\tiny $\catvariableof{2}$};
	\draw[->-] (T2) -- (T3);
	\node [circle, draw, thick, fill=gray!50] (T4) at (15,0) {\tiny $\catvariableof{3}$};
	\draw[->-] (T3) -- (T4);
	\draw[->-] (T4) -- (18,0);
