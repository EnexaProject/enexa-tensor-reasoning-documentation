...
\draw[->-] (5.5,-5)--(5.5,-3) node[midway,right] {\colorlabelsize $\headvariableof{\neg\exformula}$};

\node[anchor=center] (text) at (5.5,-6) {$\bencodingof{\lnot}$};
...
\draw[->-] (9.5,-5)--(9.5,-3) node[midway,right] {\colorlabelsize $\headvariableof{\exformula\circ\secexformula}$};
