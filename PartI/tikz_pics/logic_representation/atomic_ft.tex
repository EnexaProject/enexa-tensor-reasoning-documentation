...
\drawatomcore{3.5}{-8}{$\rencodingof{\formulaof{\atomenumerator}}$}
\drawatomindices{3.5}{-12}	
\draw[->] (5.5,-9)--(5.5,-7) node[midway,right] {\tiny ${\catvariableof{\formulaof{\atomenumerator}}}$};
...
\draw[->] (18.5,-9)--(18.5,-7) node[midway,right] {\tiny ${\catvariableof{\formulaof{\atomenumerator}}}$};
