...
\draw[->] (1.5,-3)--(1.5,-5) node[midway,right] {\tiny $\catvariableof{a \land b \land \lnot c}$}; 
...
\draw (-1,-1) rectangle (4, -3);
\node[anchor=center] (text) at (1.5,-2) {\small $\concoreof{\land}$};

\draw[->] (1.5,-3) --(1.5,-5) node[midway,right]{\tiny $\catvariableof{a \land b}$};

\draw (5,-1) rectangle (7, -3);
\node[anchor=center] (text) at (6,-2) {\small $\concoreof{\lnot}$};

\draw[->] (6,-3) --(6,-5) node[midway,right]{\tiny $\catvariableof{\lnot c}$};
	
\draw (0.5,-5) rectangle (6.5,-7);
\node[anchor=center] (text) at (3.5,-6) {\small $\concoreof{\land}$};
	
\draw[->] (4,-7) -- (4,-9) node[midway,right] {\tiny $\catvariableof{a \land b \land \lnot c}$};
