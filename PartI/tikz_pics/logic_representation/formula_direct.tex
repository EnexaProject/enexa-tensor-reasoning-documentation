...
%\draw[->-] (2,-1)--(2,1) node[midway,right] {\colorlabelsize $\catvariableof{\exformula}$};
...
%\node[anchor=center] (text) at (1,0) {\corelabelsize $\onehotmapof{\exformula(\atomindices)}$};
%\draw[->-] (1,1)--(1,3) node[midway,right] {\colorlabelsize $\catvariableof{\exformula}$};
