\begin{tikzpicture}[scale=0.315]
    ...
    \begin{scope}
        ...
        \filldraw[\concolor] (-3,0.6) circle (0.15cm);
        \filldraw[\concolor] (-1.5,0.8) circle (0.15cm);
        \filldraw[\concolor] (-1,-0.4) circle (0.15cm);
    ...
    \draw[fill,\concolor] (A) circle (0.15cm);
    \draw[fill] (B) circle (0.15cm);
    \draw[fill,\concolor] (C) circle (0.15cm);
    \draw[fill,\concolor] (D) circle (0.15cm);
    \draw[fill] (E) circle (0.15cm);

    % Base measure mean
    \draw[dashed,\concolor] (A) -- (C) -- (D) -- cycle;

    \draw[fill,\concolor] (1.5,8) circle (0.15cm);
    ...
    \draw[fill,\probcolor] (0.5,11) circle (0.15cm);
    ...
    \begin{scope}
        ...
        \draw[fill,\probcolor] (-9,11) circle (0.15cm);

        \node[below,\concolor] at (-6,6) {$\zeros$};
        \draw[fill,\concolor] (-6,6) circle (0.15cm);
