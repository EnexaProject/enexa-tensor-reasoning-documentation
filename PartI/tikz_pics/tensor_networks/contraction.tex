...
\draw (0,-3)--(0,-5) node[midway,left] {\tiny $\catlegof{1}$}; 
\draw (4,-3)--(4,-5) node[midway,left] {\tiny $\catlegof{3}$}; 
...
\draw (0,-3)--(0,-4) node[midway,right] {\tiny $\catlegof{0}$}; 
\draw (-1,-4) rectangle (1,-6);
\node[anchor=center] (text) at (0,-5) {\small $\ones$};

\draw (2,-3)--(2,-5) node[midway,right] {\tiny $\catlegof{1}$}; 
\draw (4,-3)--(4,-5) node[midway,right] {\tiny $\catlegof{2}$}; 
...
\draw (7,-5) -- (7,-6);
\draw (7,-6)--(7,-7) node[midway,right] {\tiny $\catlegof{2}$}; 
