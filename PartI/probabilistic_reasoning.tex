...
To proof the theorem, we show in the following lemma a characterization of the derivative of functions

% Could put it into contraction equations?
\begin{lemma}\label{lem:difMNExpectation}
	For any function $\exfunction(\hypercoreof{\edge})[\catvariableof{\nodes}]$ we have
	\begin{align*}
		 \difwrt{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} &
		\sbcontraction{\normationof{\extnet}{\catvariableof{\nodes}},\exfunction(\hypercoreof{\edge})[\catvariableof{\nodes}]} \\
		= & 
		\frac{\normationof{\extnet}{\indexedcatvariableof{\edge}}}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} 
		\Big( \sbcontraction{\normationofwrt{\extnet}{\catvariableof{\nodes/\edge}}{\indexedcatvariableof{\edge}}, \exfunction(\hypercoreof{\edge})[\catvariableof{\nodes/\edge},\indexedcatvariableof{\edge}]} \\
		& \quad \quad \quad \quad \quad - \sbcontraction{\normationof{\extnet}{\catvariableof{\nodes}}, \exfunction(\hypercoreof{\edge})[\catvariableof{\nodes}]}
		\Big) \\
		& + \contraction{ \normationof{\extnet}{\catvariableof{\nodes}}
		\difofwrt{\exfunction(\hypercoreof{\edge})[\catvariableof{\nodes}]}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}}
		}
	\end{align*}
\end{lemma}
\begin{proof}
...
\begin{proof}[Proof of Theorem~\ref{the:updateEquationStructuredVariational}]
	...
	\end{align*}
	and with Lemma~\ref{lem:difMNExpectation} 
	\begin{align*}
		\difwrt{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} \sbcontraction{\energytensor,\probtensor} 
		= 
		\frac{\normationof{\extnet}{\indexedcatvariableof{\edge}}}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} 
		\Big( & \sbcontraction{\normationofwrt{\extnet}{\catvariableof{\nodes/\edge}}{\indexedcatvariableof{\edge}}, \energytensorat{\catvariableof{\nodes/\edge},\indexedcatvariableof{\edge}}} \\
	...
	and thus
	\begin{align*}
		\difwrt{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} \sentropyof{\normationof{\extnet}{\shortcatvariables}}
		= & \frac{\normationof{\extnet}{\indexedcatvariableof{\edge}}}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}} 
			\sum_{\secedge\in\edges} \Big(
			 \sbcontraction{\normationofwrt{\extnet}{\catvariableof{\nodes/\edge}}{\indexedcatvariableof{\edge}}, \hypercoreofat{\secedge}{\catvariableof{\secedge/\edge},\indexedcatvariableof{\secedge\cap\edge}}} \\
		&	 \quad \quad  \quad \quad \quad \quad \quad \quad -  \sbcontraction{\normationof{\extnet}{\catvariableof{\nodes}}, \hypercoreofat{\secedge}{\catvariableof{\secedge}}} 
		\Big) \\
		&- \sbcontraction{\normationof{\extnet}{\catvariableof{\nodes}}, \frac{1}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}}} \\
		% \frac{\normationof{\extnet}{\indexedcatvariableof{\edge}}}{\hypercoreofat{\edge}{\indexedcatvariableof{\edge}}}  \cdot expectation of derivative of -ln \\
		&+ \frac{\contraction{\{\hypercoreof{\secedge} : \secedge\in\edges, \secedge\neq \edge\}}
		}{\contraction{\{\hypercoreof{\secedge} : \secedge\in\edges\}}}
	\end{align*}
