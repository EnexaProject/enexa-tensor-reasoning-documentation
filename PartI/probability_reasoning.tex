...
We recall the mean parameters of a statistics $\sstat$ from \defref{def:meanPolytope} and investigate the relation between the canonical parameter $\canparam$ of a member of an exponential family and the corresponding mean parameter $\meanparam$.
...
%    is called the polytope of realizable mean parameters.
    ...
    The map
    \begin{align*}
        \forwardmap :  \parspace\rightarrow\parspace
    \end{align*}
    ...
    \begin{align*}
        \backwardmap : \imageof{\forwardmap} \rightarrow \parspace
    \end{align*}
...
\sect{Reasoning on mean parameter polytopes}
