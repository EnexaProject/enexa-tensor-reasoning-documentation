...
\begin{definition}[Probability Tensor]\label{def:probabilityDistribution} % From the axioms of Kolmogorov!
...
% Characterization
\begin{theorem}[Hammersley-Clifford]\label{the:condIndMN}
...
\begin{definition}\label{def:realizableStatDistributions}
