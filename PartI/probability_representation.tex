...
\begin{theorem}\label{the:sufficientStatisticActCoreExistence}
    ...
    \begin{align*}
        \probat{\shortcatvariables} = \contractionof{\bencodingofat{\sstat}{\headvariables,\shortcatvariables},\actcoreof{\headvariables}}{\shortcatvariables} \, .
    \end{align*}
\end{theorem}
\begin{proof}
    ...
    \begin{align*}
        \probat{\shortcatvariables} = \contractionof{\bencodingofat{\sstat}{\headvariables,\shortcatvariables},\actcoreof{\headvariables}}{\shortcatvariables} \, . & \qedhere
    \end{align*}
\end{proof}
...
\begin{align*} % ! First occurance of realizabledists ?
    ...
    := \left\{\normalizationof{\bencodingofat{\sstat}{\headvariables,\shortcatvariables},\actcoreof{\headvariables}}{\shortcatvariables} \right\}
\end{align*}
