...
\begin{theorem}[Face measure representation]\label{the:faceMeasureCharacterization}
    ...
    \begin{align*}
         \basemeasureofat{\sstat,\facecondset}{\shortcatvariables}
         =\contractionof{\bencodingofat{\sstat}{\headvariableof{[\seldim]},\shortcatvariables},\kcoreat{\headvariableof{[\seldim]}}}{\shortcatvariables}
    \end{align*}
    where
    \begin{align*}
        \kcoreat{\headvariableof{[\seldim]}}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \contractionof{\bencodingofat{\sstat}{\headvariableof{[\seldim]},\shortcatvariables},\kcoreat{\headvariableof{[\seldim]}}}{\shortcatvariables} \, . \qedhere
    \end{align*}
\end{proof}

Let us notice, that $\kcoreat{\headvariableof{[\seldim]}}$ in \theref{the:faceMeasureCharacterization} is a sparse tensor with basis $\cpformat$ rank $\cardof{\genfacesetof{\facecondset}\cup\imageof{\sstatencoding}}$ (see \charef{cha:sparseRepresentation}).
