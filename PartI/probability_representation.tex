...
\begin{proof}
    ...
    \begin{align*}
        \probat{\shortcatvariables} = \contractionof{\bencodingofat{\sstat}{\headvariableof{[\seldim]},\shortcatvariables},\actcoreof{\headvariableof{[\seldim]}}}{\shortcatvariables} \, . & \qedhere
    \end{align*}
\end{proof}
...
\begin{definition}
    ...
    \begin{align*}
        ...
        = \left\{ \normalizationof{\{\bencodingofat{\sstat}{\sstatcatof{[\seldim]},\shortcatvariables}\} \cup \{\hypercoreofat{\edge}{\sstatcatof{\edge}} \wcols \edge\in\edges \}}{\shortcatvariables}  \, : \,\hypercoreofat{\edge}{\sstatcatof{\edge}}\in\bigotimes_{\selindex\in\edge}\rr^{\headdimof{\selindex}}, \, \zerosat{\sstatcatof{\edge}}\prec\hypercoreofat{\edge}{\sstatcatof{\edge}} \right\} \, .
    \end{align*}
    ...
    \begin{align*}
        \realizabledistsof{\sstat,\graph}
        = \left\{ \normalizationof{\{\bencodingofat{\sstat}{\sstatcatof{[\seldim]},\shortcatvariables}\} \cup \{\hypercoreofat{\edge}{\sstatcatof{\edge}} \wcols \edge\in\edges \} \cup \{\basemeasurewith\}}{\shortcatvariables}  \, : \,\hypercoreofat{\edge}{\sstatcatof{\edge}}\in\bigotimes_{\selindex\in\edge}\rr^{\headdimof{\selindex}}, \, \zerosat{\sstatcatof{\edge}}\prec\hypercoreofat{\edge}{\sstatcatof{\edge}} \right\} \, .
    \end{align*}
\end{definition}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \convhullof{\sencsstatat{\indexedshortcatvariables,\selvariable} \, : \, \basemeasureat{\indexedshortcatvariables}=1} \, . \qedhere
    \end{align*}
\end{proof}
...
\begin{theorem}[Face measure representation]\label{the:faceMeasureCharacterization}
    ...
    \begin{align*}
         \basemeasureofat{\sstat,\facecondset}{\shortcatvariables}
         =\contractionof{\sstatccwith,\kcoreofat{\facecondset}{\headvariableof{[\seldim]}}}{\shortcatvariables}
    \end{align*}
    where
    \begin{align*}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        = \contractionof{\sstatccwith,\onehotmapofat{\headindex^{\meanparam}_{[\seldim]}}{\headvariableof{[\seldim]}}}{\shortcatvariables}
    \end{align*}
    ...
    \begin{align*}
        ...
        &= \contractionof{\bencodingofat{\sstat}{\headvariableof{[\seldim]},\shortcatvariables},\kcoreofat{\facecondset}{\headvariableof{[\seldim]}}}{\shortcatvariables} \, . \qedhere
    \end{align*}
\end{proof}
...
\begin{example}[Vertices]\label{exa:vertexMeasures}
...
We notice that $\kcoreofat{\facecondset}{\headvariableof{[\seldim]}}$ in \theref{the:faceMeasureCharacterization} is a sparse tensor with basis $\cpformat$ rank $\cardof{\genfacesetof{\facecondset}\cup\imageof{\sstatencoding}}$ (see \charef{cha:sparseRepresentation}).
\begin{align*}
    \sparsityof{\kcoreofat{\facecondset}{\headvariableof{[\seldim]}}}
    = \cardof{
...
\begin{example}[Maximal face]\label{exa:maximalFaceMeasure}
...
We have
\begin{align*}
    \meanparamat{\sstat,\zeros,\basemeasure} = \frac{1}{\contraction{\basemeasure}} \sum_{\shortcatindices\wcols\basemeasureat{\indexedshortcatvariables}=1}  \sencsstatat{\indexedshortcatvariables,\selvariable}
\end{align*}
and therefore understand $\meanparamat{\sstat,\zeros,\basemeasure}$ as the weighted center of $\meansetof{\sstat,\basemeasure}$, where weights are allocated on the image of the statistics encoding by the cardinality of their pre-images.
