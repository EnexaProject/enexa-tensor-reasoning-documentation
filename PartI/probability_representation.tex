...
\begin{proof}
	...
	But this follows from the normation of $\probtensor$ and the commutativity of contractions (see \theref{the:splittingContractions} in \charef{cha:localContractions}) as
