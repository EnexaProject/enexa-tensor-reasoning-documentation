...
\begin{proof}
    ...
    $\sentropyof{\probtensor|\sstat}=0$ is further equivalent to the existence of a function $\exfunction:\rr^{\seldim}\rightarrow[0,1]$, such that for each $\shortcatindices$
    \begin{align*}
