...
%\subsect{\BasisEncoding{} of formulas}
...
\begin{theorem}[Propositional formulas as \ComputationActivationNetwork{}]
...
% Maps between factored systems -> Comment maybe on extra head variable?
...
%	The \basisEncoding{} of any atomic formula $\atomicformulaofat{\atomenumerator}{\shortcatvariables}$ has a tensor decomposition by
    \begin{align*}
