\section{Propositional Logics}\label{cha:logicalRepresentation}
...
In \defref{def:subsetEncoding} in Part~III will define encodings of arbitrary sets based on index interpretation maps.
...
Given a factored system with $\atomorder$ atoms $\shortcatvariables$ and a propositional formula $\formula$, the relational encoding of $\formula$ (see Definition~\ref{def:functionRepresentation}) is the tensor
	\[ \rencodingofat{\formula}{\shortcatvariables,\formulavar} \in  \left(\atomspace \right) \otimes \rr^2 \]
decomposable as
\begin{align} 
	\rencodingofat{\formula}{\shortcatvariables,\formulavar} 
...
\begin{lemma}\label{lem:formulaEncodingDecomposition}
	For any formula $\formula$ we have
		\[ \rencodingofat{\formula}{\shortcatvariables,\formulavar} 
		= \formulaat{\shortcatvariables} \otimes \onehotmapofat{1}{\formulavar} 
		+ \lnot\formulaat{\shortcatvariables} \otimes  \onehotmapofat{0}{\formulavar} \, . 
		 \]
	In particular
		\[ \formulaat{\shortcatvariables} = \contractionof{
		\rencodingofat{\formula}{\shortcatvariables,\formulavar},\onehotmapofat{1}{\formulavar}
		}{\shortcatvariables} \, . \]
\end{lemma}
\begin{proof}
%% Decomposition
	...
	\begin{align} 
		 \rencodingofat{\formula}{\shortcatvariables,\formulavar}  = & \fbasisat{\formulavar} \otimes \left( \sum_{\formulazerocoordinates}  \onehotmapofat{\shortcatindices}{\shortcatvariables} \right) \\
...
\begin{theorem}
	...
	The relational encoding of any atomic formula $\formulaofat{\atomenumerator}{\shortcatvariables}$ has a tensor decomposition by
		\[ \rencodingofat{\formulaof{\atomenumerator}}{\shortcatvariables,\catvariableof{\formulaof{\atomenumerator}}}
		= \contractionof{\identityat{\catvariableof{\atomenumerator},\catvariableof{\formulaof{\atomenumerator}}}}{\shortcatvariables}
		= \identityat{\catvariableof{\atomenumerator},\catvariableof{\formulaof{\atomenumerator}}} \otimes \onesat{\catvariableof{[\catorder]/\{\atomenumerator\}}} \, . \]
...
\begin{proof}
	...
	\begin{align*}
		\rencodingofat{\atomicformulaof{\atomenumerator}}{\shortcatvariables,\catvariableof{\formulaof{\atomenumerator}}}
		=& \sum_{\catindices\in\atomstates} \onehotmapofat{\catindices}{\shortcatvariables} \otimes \onehotmapofat{\formulaofat{\atomenumerator}{\indexedcatvariables}}{\catvariableof{\formulaof{\atomenumerator}}} \\
		...
		=& \contractionof{\identityat{\catvariableof{\atomenumerator},\catvariableof{\formulaof{\atomenumerator}}}}{\shortcatvariables,\catvariableof{\formulaof{\atomenumerator}}} \, .
	\end{align*} 
\end{proof}
...
\begin{proof}
	...
	This follows from an iterative application of \theref{the:compositionByContraction} to be shown in \charef{cha:tensorEncodings}.
\end{proof}
