...
\begin{definition}\label{def:meanForwardBackward}
	...
	We call the tensor
		\[ \meanparam = \sbcontractionof{\probtensor,\sencodingof{\sstat}}{\selvariable} \]
	the mean parameter tensor to a distribution $\probtensor$ of an exponential family.
	The set 
		\[ \meansetof{\sstat} = \left\{\contractionof{\probtensor,\sencodingof{\sstat}}{\selvariable} \, : \, \probtensor\in\probtensorset \right\} \, , \]
...
\begin{theorem}
	...
	\begin{align*}
		\meansetof{\sstat} = \convhullof{\sencsstatat{\indexedshortcatvariables,\selvariable} \, : \, \shortcatindices\in\facstates} \, . 
	\end{align*}	
\end{theorem}
\begin{proof}
