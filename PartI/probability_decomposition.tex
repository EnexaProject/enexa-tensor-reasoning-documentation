...
\red{Overwork: Further integration of selection encodings + Cumulative function!}
...
%% Introducing cumulant function
Let us now ease the notation by introducing the cumulant function
...
\begin{definition}
	...
	with $\forwardmapof{\canparam} = \sbcontractionof{\expdist,\sencodingof{\sstat}}{\selvariableof{\sstat}}$ is called the forward map of the exponential family and any map
