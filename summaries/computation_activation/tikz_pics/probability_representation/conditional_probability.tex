\begin{tikzpicture}[scale=0.3, thick] % , baseline = -3.5pt
    ...
    \begin{scope}
        ...
        \node[anchor=center] (text) at (-18,-2) {\corelabelsize $\hypercoreat{\catvariableof{0}|X_1=x_1}$};
    ...
    \begin{scope}
        ...
        \node[anchor=center] (text) at (-8,-2) {\corelabelsize $\hypercoreat{\exrandom,\secexrandom}$};
    ...
    \begin{scope}
        ...
        \node[anchor=center] (text) at (-18,-2) {\corelabelsize $\hypercoreat{\catvariableof{0}|X_1}$};
