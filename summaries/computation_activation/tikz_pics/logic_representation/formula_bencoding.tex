\begin{tikzpicture}[scale=0.35, thick] % , baseline = -3.5pt
    ...
    \begin{scope} [shift={(25.5,-0.5)}]
        ...
        \draw (-3.25,-2) rectangle (5.25,-4);
        \node[anchor=center] (text) at (1,-3) {\corelabelsize $\sum_{\shortcatindices \wcols \formula(\shortcatindices)=0}\onehotmapof{\shortcatindices}$};
    ...
    \begin{scope} [shift={(35.5,-0.5)}]
        ...
        \draw (-3.25,-2) rectangle (5.25,-4);
        \node[anchor=center] (text) at (1,-3) {\corelabelsize $\sum_{\shortcatindices \wcols \formula(\shortcatindices)=1}\onehotmapof{\shortcatindices}$};
