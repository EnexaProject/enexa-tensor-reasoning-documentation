...
\end{align*}
We further optimize the coordinates $\selindex\in[\seldim]/\hardlegset$ of $\canparamwithin$ alterantingly by the coordiante descent steps
\begin{align*}
...
\end{align*}
Let us summarize the procedure in Algorithm~\ref{alg:AMM_HLN}.
...
This is the computational bottleneck of the algorithm for 
% CITE CAMEL AND STUF
...
For more details we refer to~\cite[Chapter~9]{goessmann2025}.
