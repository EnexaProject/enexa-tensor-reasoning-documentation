...
\begin{figure}
    \begin{center}
        \input{../tikz_pics/expdist_elementary}
    \end{center}
    \caption{\alex{Missing base measure in the diagram! - Find convention.}
    Tensor Network diagram of a member of an exponential family before normalization as an \CompActNet{} with elementary activation, that is an element in $\cansof{\sstat,\elgraph,\basemeasure}$.}\label{fig:expdistElementary}
\end{figure}
