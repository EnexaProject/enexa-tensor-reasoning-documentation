\begin{example}[Order Statistic for Boolean Variables: Coin toss interpretation]\label{exa:coinToss}
    ...
    \end{align*}
    When the order statistic is sufficient, the detailed order of the outcomes in uninformative about the member $\theta\in\Theta$ from which the random variables have been drawn.
    ...
    \begin{align*}
        ...
        = \theta^{\catorder-\catenumerator} \cdot \theta^{\catenumerator} \, ,
    \end{align*}
    and for $\theta\in\{0,1\}$
    \begin{align*}
