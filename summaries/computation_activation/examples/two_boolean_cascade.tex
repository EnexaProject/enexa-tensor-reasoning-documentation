...
%    \]
    ...
    \begin{align*}
        \probat{\catvariableof{0},\catvariableof{1}} &= \normalizationof{\bencodingofat{+}{\headvariable,\catvariableof{0},\catvariableof{1}},\acttensorat{\headvariable}}{\catvariableof{0},\catvariableof{1}},
    \end{align*}
    such that
    \begin{align*}
        \probat{\catvariableof{0}=\catvariableof{0},\catvariableof{1}=\catvariableof{1}} &= \frac1Z\contractionof{\bencodingofat{+}{\headvariable,\catvariableof{0},\catvariableof{1}},\acttensorat{\headvariable}}{\catvariableof{0}=\catvariableof{0},\catvariableof{1}=\catvariableof{1}}\\
        &=\frac{1}{Z}\sum_{y=0}^{2}\beta^+[Y = y,\catvariableof{0} = \catvariableof{0},\catvariableof{1} = \catvariableof{1}]\;\xi[y]
        =\frac{1}{Z}\,\xi\!\big[ Y = \catvariableof{0}+\catvariableof{1}\big],
    \end{align*}
