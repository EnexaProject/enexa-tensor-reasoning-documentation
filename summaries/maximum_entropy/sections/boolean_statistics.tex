...
\begin{theorem}
    ...
    Any maximum entropy distribution is realized by $\elrealizabledistsof{\hlnstat}$ if and only if the mean parameter is on an relative interior of a cube-like face.
\end{theorem}
\begin{proof}
