...
\begin{definition}
    ...
    %\begin{align*}
    %    \facesymbol = \meansetof{\hlnstat,\basemeasure} \cap \facesymbolof{(\variableset,\headindexof{\variableset})}\, .%{\{\formulaof{\selindex}\wcols\selindexin\},\trivbm} \, .
    %\end{align*}
\end{definition}
...
%        \item[(i)] There is a face $\facesymbolof{(\variableset,\headindexof{\variableset})}$ of the hypercube $\fullparcube$ such that
%        \begin{align*}
%            \facesymbol=\hlnmeanset\cap\facesymbolof{(\variableset,\headindexof{\variableset})}
%        \end{align*}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \end{cases} \, .
    \end{align*}
    By construction ${\acttensorlegwith} = \hardactlegwith$ (see \exaref{exa:hypercube}) follows for all $\selindexin$ and therefore $\acttensorwith=\hardacttensorwith$.
