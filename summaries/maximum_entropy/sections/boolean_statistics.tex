...
\begin{example}[Hypercube]
    ...
    \end{align*}
    Its face lattice $\facelatticeof{\fullparcube}$ can be enumerated by choosing a subset $\variableset\subset[\seldim]$ and indices $\headindexof{\variableset}\in\bigtimes_{\selindex\in\variableset}[2]$ and represented by the cartesian products
    \begin{align*}
