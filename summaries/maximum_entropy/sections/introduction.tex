...
\begin{align*}
    \sentropyof{\probwith} = \contraction{\probwith,\lnof{\probwith},\basemeasurewith} \, .
\end{align*}

The maximum entropy problem given a mean parameter $\genmeanwith$ is stated by
\begin{equation}
    \tag{$\mathrm{P}_{\sstat,\meanparam,\basemeasure}$}
    \max_{\probwith\in\bmrealprobof{\basemeasure}} \sentropyof{\probwith}
    \stspace
