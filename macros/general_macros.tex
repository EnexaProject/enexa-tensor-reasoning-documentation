...
} % Use for tnreason script language, lstlistings for python code!

%\newenvironment{centeredcode}{\begin{lstlisting}}{\end{lstlisting}} does not work!

\newenvironment{centeredscript}
{\begin{center}
     \begin{algorithmic}
         \hspace{1cm}}
{\end{algorithmic}\end{center}}
...
\newcommand{\mpformulaof}[1]{\formula^{\mlnstat,#1}}
\newcommand{\mpformula}{\mpformulaof{\variableset,\headindexof{\variableset}}} % mean parameter formula
\newcommand{\mpformulaat}[1]{\mpformula\left[#1\right]}
\newcommand{\mpformulawith}{\mpformulaat{\shortcatvariables}}
\newcommand{\vertexformula}{\mpformulaof{[\seldim],\meanparam}}
...
\newcommand{\enumformulaccwith}{\bencodingofat{\enumformula}{\enumformulavar,\shortcatvariables}}
\newcommand{\enumformulaac}{\actcoreof{\enumformula,\canparamat{\indexedselvariable}}}
\newcommand{\enumformulaacwith}{\actcoreofat{\enumformula,\canparamat{\indexedselvariable}}{\headvariableof{\selindex}}}
...
\newcommand{\selectorcore}{{\bencodingof{\vselectionsymbol}}}
\newcommand{\selectorcoreof}[1]{\bencodingof{\vselectionmapof{#1}}}
...
\newcommand{\hlnfacemeasure}{\basemeasureof{\mlnstat,\facecondset}}
\newcommand{\hlnfacemeasureat}[1]{\basemeasureofat{\mlnstat,\facecondset}{#1}}
...
\newcommand{\mlnstatccwith}{\bencodingofat{\mlnstat}{\sstatheadvariables,\shortcatvariables}}
...
\newcommand{\hlnfaceset}{\facesetofspec{\facecondset}{\mlnstat,\basemeasure}}
