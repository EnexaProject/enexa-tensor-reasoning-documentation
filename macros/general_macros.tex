...
\newcommand{\mathrdftype}{\mathrm{rdf\mathord{:}type}}
...
\newcommand{\patterncreator}{\psi}
\newcommand{\patterncreatorofat}[2]{\patterncreator_{#1}\left[#2\right]}
...
\newcommand{\exfunctionof}[1]{\exfunction^{#1}}
