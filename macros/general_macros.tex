...
\newcommand{\hlnat}[1]{\probofat{\mlnstat,\hybridparam}{#1}}
...
\newcommand{\folexformulawith}{\folexformulaat{\worldvariables,\indvariableof{\folexformula}}}
...
\newcommand{\supportedworlds}{\dataworld \wcols \groundingofat{\impformula}{\shortindvariables} = \fixedimpformulawith}
