...
\newcommand{\idrestrictedto}[1]{\mathrm{Id}|_{#1}}
...
\newcommand{\cumfunction}{A}
\newcommand{\cumfunctionof}[1]{\cumfunction(#1)}
\newcommand{\dualcumfunction}{A^*}

\newcommand{\forwardmapof}[1]{F^{#1}}
\newcommand{\forwardmap}{\forwardmapof{(\sstat,\basemeasure)}}
\newcommand{\backwardmapof}[1]{B^{#1}}
\newcommand{\backwardmap}{\backwardmapof{(\sstat,\basemeasure)}}
