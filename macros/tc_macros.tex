...
\newcommand{\inset}{\arbset^{\insymbol}}
\newcommand{\outset}{\arbset^{\outsymbol}}

\newcommand{\incatindex}{\catindexof{\insymbol}}
\newcommand{\outcatindex}{\catindexof{\outsymbol}}

%\newcommand{\catindexin}{\catindexof{\mathrm{in}}}
%\newcommand{\catindexout}{\catindexof{\mathrm{out}}}
...
%\newcommand{\variableset}{M}




%% Main Variables: Term, Selection, Categorical
...
\newcommand{\dataindex}{\datindex}
\newcommand{\secdataindex}{\tilde{\datindex}}
\newcommand{\datavariable}{\datvariable}
\newcommand{\datanum}{\datdim}
\newcommand{\dataindexin}{\dataindex\in[\datanum]}
\newcommand{\datain}{\dataindex\in[\datanum]}
\newcommand{\data}{\{\datapointof{\dataindex}\}_{\dataindexin}}
...
\newcommand{\seccatvariables}{\seccatvariableof{0},\ldots,\seccatvariableof{p-1}}
\newcommand{\indexedseccatvariables}{\indexedseccatvariableof{0}\ldots,\indexedseccatvariableof{\secatomorder-1}} 

\newcommand{\catvariablesinset}[1]{\catvariableof{\node} \, : \, \node \in #1}
\newcommand{\seccatindexof}[1]{\seccatindex_{#1}}

\newcommand{\catindices}{\catindexlist}
\newcommand{\tildecatindices}{\tilde{\catindex}_{0},\ldots,\tilde{\catindex}_{\atomorder-1}}
...
\newcommand{\facstates}{\bigtimes_{\atomenumeratorin}[\catdimof{\atomenumerator}]}
\newcommand{\facdim}{\prod_{\atomenumeratorin}\catdimof{\atomenumerator}}
\newcommand{\secfacstates}{\bigtimes_{\secatomenumerator\in[\secatomorder]}[\catdimof{\secatomenumerator}]}

\newcommand{\facspace}{\catspace}
\newcommand{\secfacspace}{\bigotimes_{\secatomenumerator\in[\secatomorder]} \rr^{\catdimof{\secatomenumerator}}}
...
\newcommand{\datamap}{D}
\newcommand{\datamapof}[1]{\datamap(#1)}
\newcommand{\datapointof}[1]{\datamapof{#1}}%{\datamap_{#1}}
...
% DecompositionIndex -> Use Datavariable for that
\newcommand{\decvariable}{\datvariable} 

\newcommand{\decindex}{\parindex} % INCONSISTENT!
\newcommand{\decdim}{\parlegdim}
\newcommand{\decindexin}{\decindex\in[\decdim]}
\newcommand{\inddecvar}{\datavariable=\decindex}
...
%\newcommand{\slicesparsityof}[1]{\tilde{\ell} \left(#1\right)}
\newcommand{\slicesparsityof}[1]{\slicerankwrtof{\catorder}{#1}}
...
\newcommand{\slicerankwrtof}[2]{\mathrm{rank}^{#1}\left(#1\right)}
