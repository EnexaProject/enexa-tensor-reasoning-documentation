...
\newcommand{\breakablenormationofwrt}[3]{\big\langle #1 \big\rangle \big[ #2 | #3 \big]}
...
\newcommand{\rencodingof}[1]{\beta^{#1}}
\newcommand{\rencodingofat}[2]{\rencodingof{#1}\left[#2\right]}
\newcommand{\rencodingwith}{\rencodingofat{\exfunction}{\headvariableof{\exfunction},\shortcatvariables}}
...
\newcommand{\actcorewith}{\actcoreofat{\selindex,\canparamat{\indexedselvariable}}}

\newcommand{\conactcore}{N}
