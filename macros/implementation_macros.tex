...
%
\newcommand{\defaultCoreType}{\inlinecode{NumpyCore}} % as in engine.core_creation
\newcommand{\defaultContractionMethod}{\inlinecode{NumpyEinsum}} % as in engine.contraction_handling