...
The $\cpformat$ format (see \charef{cha:sparseCalculus}) can in principle establish storage in linear with the order.
...
In particular, we distinguish between the schemes of coordinate, basis and sparse calculus.%, in \charef{cha:coordinateCalculus}, \charef{cha:basisCalculus} and \charef{cha:sparseCalculus}.
...
Basis calculus in \charef{cha:booleanCalculus} introduces generic encodings of subsets, relations and functions by boolean tensors used in previous parts.
...
In \charef{cha:sparseCalculus} we provide sparse schemes oriented on the $\cpformat$ format for the storage of tensors.
...
In \charef{cha:sparseCalculus} we define restricted $\cpformat$ decompositions of tensors for sparse representations of $\atomorder$-ary relations, which appear in sparse representation of relational databases.
\\ \ \\
% Reasoning
\textbf{\focustwospec}
\\ \ \\
