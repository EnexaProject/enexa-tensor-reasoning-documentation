...
\red{Statistical Models of Knowledge Graphs going beyond the typical single edge type perspective of network science.}


\subsection{Represention schemes of systems}

\red{Following the book \cite{russel_artificial_2021}: Atomic, Factored and Structured Representations, which are framed as ontological commitments.}
