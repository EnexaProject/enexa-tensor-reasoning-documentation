...
\node[anchor=center] (text) at (9,-3) {\tiny $\catvariableof{3}$};
...
\node[anchor=center] (text) at (3,-2) {\small $\hypercoreofat{\edge}{\catvariableof{0},\catvariableof{1},\catvariableof{2},\catvariableof{3}}$};
...
\draw[midarrow] 
    (2,-3)--(2,-5) node[midway,left] {\tiny $\catvariableof{1}$};
\draw[midarrow] 
    (4,-5)--(4,-3) node[midway,left] {\tiny $\catvariableof{2}$};
\draw[midarrow] 
   (6,-5)--(6,-3) node[midway,right] {\tiny $\catvariableof{3}$};
\end{scope}
