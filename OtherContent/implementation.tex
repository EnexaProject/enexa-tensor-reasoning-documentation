...
\sect{Subpackage \sprepresentation}
...
\sect{Subpackage \spreasoning}

The \spreasoning subpackage implements basic tensor network algorithms with calls of specific execution in \spengine.
