...
%        \textbf{coreType}          & \textbf{Used Package}                      & \text{Storage of \inlinecode{values}}  & \textbf{Sparse basis+ $\cpformat$ support}\\
%        \hline
%        \inlinecode{NumpyCore} & $\mathrm{numpy}$                           & \inlinecode{numpy.array}                                 & No                                         \\
%        \hline
%        \inlinecode{PandasCore}      & $\mathrm{pandas}$                          & \inlinecode{pandas.DataFrame}                            & Yes                                        \\
%        \hline
%        \inlinecode{TentrisCore}     & $\mathrm{tentris}$ \cite{pan_tentris_2020} & \inlinecode{tentris.hypertrie} & Yes\\
%        \hline
%        \inlinecode{PolynomialCore}  & $--$                                       & Storing the values in a basis+ $\cpformat$ Decomposition & Yes\\
%        \hline
%    \end{tabular}
%\end{center}
