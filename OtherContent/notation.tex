\chapter{Notation and Basic Concepts}\label{cha:TensorNetworks}
...
\sect{Categorical Variables and Representations}
...
\red{To ease notation, we sometimes omit the set notation by brackets $\{\cdot\}$ and specify the tensors to be contracted with the delimiter "," (see e.g. \exaref{exa:matrixProduct}).}
...
%	\end{center}
%	\caption{
%		Depiction of the Matrix Vector Product (see \exaref{exa:matrixProduct}).
%	}\label{fig:matrixProduct}
%\end{figure}
...
%	\end{center}
%	\caption{
%		Depiction of the Matrix Vector Product (see \exaref{exa:hadamard}).
%	}\label{fig:hadamard}
%\end{figure}
...
\begin{center}
	\input{OtherContent/tikz_pics/notation/rencoding.tex}
\end{center}
