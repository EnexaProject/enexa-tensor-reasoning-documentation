...
%    \input{PartIII/contraction_concentration.tex} % To be integrated in Concentration!
    ...
    \input{PartIII/contraction_equations.tex} % To be integrated in Coordinate Calculus!
