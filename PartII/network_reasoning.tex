...
Let us now characterize all the pre-images of faces, which are in $\hlnsetof{\formulaset}$.
\begin{theorem}
...
\begin{proof}
	...
	Any $\meanparam$ being the statistic encoding of a coordinate in the support of this contraction thus satisfies contraints $\meanparamat{\indexedselvariable}=0$ respectively $\meanparamat{\indexedselvariable}=1$, which are known to define faces of the cube.
\end{proof}
