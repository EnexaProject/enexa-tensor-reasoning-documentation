...
\sect{Fluctuations in \HybridLogicNetworks{}}
...
For \HybridLogicNetworks{} we have statistics consistent of boolean statistics $\enumformula$, which are logical formulas.
...
%
We here state the sphere bounds and combine with \theref{the:detGuaranteeUnconstrained}.
