...
%	\[ \lossof{\canparam} = - \probof{\cdot | \canparam}\]
...
%	The probabilistic bound can be shown based on the sub-Gaussian norm of $\widthwrtof{\canparamhypothesis}{\fluctuationtensor}$ bounded in Chapter~\ref{cha:widthBounds}.
%\end{proof}
