...
\begin{example}[Sudoku]
	...
	\end{center}
	\caption{Sudoku grid of basic categorical variables $\catvariableof{i,j}$, here drawn in the standard case of $n=3$, each with dimension $\catdim=n^2=9$.}
	\end{figure}
...
\red{Hybrid Logic Networks as bridging soft and hard logics.}
