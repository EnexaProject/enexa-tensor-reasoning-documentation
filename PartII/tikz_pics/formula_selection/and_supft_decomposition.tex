...
\draw[-<-] (5,-2.5)--(7,-2.5) node[midway,below] {\colorlabelsize $\selvariable_{1}$};
\draw[-<-] (5,-1.5)--(7,-1.5) node[midway,above] {\colorlabelsize $\selvariable_{0}$};
...
\begin{scope}[shift={(17,8)}]
	\begin{scope}[shift={(0,-10)}]
		...
		\draw (5,0) -- (12,0);
		\draw[-<-] (12,0) -- (14,0) node[midway, above] {\colorlabelsize $\selvariable_{1}$};
		...
		\draw[-<-] (12,-2) -- (14,-2) node[midway, above] {\colorlabelsize $\selvariable_{0}$};
		\drawatomindices{7}{-4}	
