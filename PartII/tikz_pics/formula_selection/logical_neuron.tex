...
\node[anchor=center] (text) at (1.5,2.75) {\small $\bencodingof{\lneuron}$}; %{\small $\bencodingof{\placeholderof{0} \placeholderof{1} \placeholderof{2}}$};
...
\node[anchor=center] (text) at (11.5,4.25) {\small $\bencodingof{\cselectionmap}$};
