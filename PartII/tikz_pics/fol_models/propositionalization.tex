\begin{tikzpicture}[scale=0.35, yscale=1, thick] % , baseline = -3.5pt
    ...
    \draw[] (6,-3) -- (6,-5) node[midway,right] {\colorlabelsize $\indvariableof{\individualorder-1}$};
    ...
    \begin{scope}
        ...
        \draw[-<-] (7.5,-3) -- (7.5,-7) node[right] {\colorlabelsize $\indvariableof{\individualorder-1}$} ;
