\begin{tikzpicture}[scale=0.35, yscale=1, thick] % , baseline = -3.5pt
    ...
    \draw[] (2,-3) -- (2,-5) node[midway,left] {\tiny $\indvariableof{0}$};
    \node[anchor=center] (text) at (4,-4) {$\cdots$};
    \draw[] (6,-3) -- (6,-5) node[midway,right] {\tiny $\indvariableof{\individualorder-1}$};
    ...
    \begin{scope}
        ...
        \draw (2.5,3) -- (2.5,2) node[midway,right] {\tiny $\catvariableof{0}$};
        \draw[->] (2.5,1) -- (2.5,2);
        ...
        \draw (10.5,2) -- (10.5,3) node[midway,right] {\tiny $\catvariableof{\atomorder-1}$};
        \draw[->] (10.5,1) -- (10.5,2);
        ...
        \draw[<-] (7.5,-3) -- (7.5,-7) node[right] {\tiny $\indvariableof{\individualorder-1}$} ;

        \node[anchor=center] (text) at (6.5,-6) {$\cdots$};

        \drawvariabledot{5.5}{-5}
        \draw[<-] (5.5,-5) -- (5.5,-7) node[left] {\tiny $\indvariableof{0}$} ;
