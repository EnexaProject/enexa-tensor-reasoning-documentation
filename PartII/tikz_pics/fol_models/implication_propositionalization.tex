...
\draw[] (2,-3) -- (2,-5) node[midway,left] {\colorlabelsize $\individualvariableof{0}$};
\node[anchor=center] (text) at (4,-4) {$\cdots$};
\draw[] (6,-3) -- (6,-5) node[midway,right] {\colorlabelsize $\individualvariableof{\individualorder-1}$};
...
%\draw (1,-1) rectangle (7,-3);
%\node[anchor=center] (text) at (4,-2) {$\bencodingof{\impformula}$};
...
\draw[->-] (2.5,1) -- (2.5,3) node[midway,right] {\colorlabelsize $\atomicformulaof{0}$};
...
\draw[->-] (10.5,1) -- (10.5,3) node[midway,right] {\colorlabelsize $\atomicformulaof{\atomorder-1}$};
...
\draw[-<-] (7.5,-3) -- (7.5,-7) node[right] {\colorlabelsize $\individualvariableof{\individualorder-1}$} ;

\node[anchor=center] (text) at (6.5,-6) {$\cdots$};

\draw[fill] (5.5,-5) circle (\dotsize);
\draw[-<-] (5.5,-5) -- (5.5,-7) node[left] {\colorlabelsize $\individualvariableof{0}$} ;


\draw (13,-2) rectangle (15,-6);
\node[anchor=center] (text) at (14,-4) {$\bencodingof{\impformula}$};
...
\node[anchor=center] (text) at (14,-3) {$\bencodingof{\impformula}$};

\draw[-<-] (12.5,-4) -- (12.5,-6) node[left] {\colorlabelsize $\individualvariableof{0}$} ;
\node[anchor=center] (text) at (14,-5) {$\cdots$};
\draw[-<-] (15.5,-4) -- (15.5,-6) node[right] {\colorlabelsize $\individualvariableof{\individualorder\shortminus1}$} ;
