...
\node[anchor=center] (text) at (4,-2) {$\groundingof{\left(\exquery\Rightarrow\folexformula\right)}$};
...
%\draw (1,-1) rectangle (7,-3);
%\node[anchor=center] (text) at (4,-2) {$\rencodingof{\exquery}$};
...
\node[anchor=center] (text) at (2.5,0) {$\rencodingof{\groundingof{\atomicqueryof{0}}}$};
...
\node[anchor=center] (text) at (10.5,0) {$\rencodingof{\groundingof{\atomicqueryof{\atomorder\shortminus1}}}$};
...
\node[anchor=center] (text) at (14,-4) {$\rencodingof{\exquery}$};
...
\node[anchor=center] (text) at (14,-3) {$\rencodingof{\exquery}$};
