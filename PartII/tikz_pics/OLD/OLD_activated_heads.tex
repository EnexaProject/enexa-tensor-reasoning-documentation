...
\draw (1.5,1)--(1.5,-1) node[midway,right] {$\atomlegindexof{b}$}; 
\draw (3,1)--(3,-1) node[midway,right] {$\atomlegindexof{c}$}; 
...
\draw (0,1)--(0,-1);%  node[midway,left] {$\atomlegindexof{a}$}; 
\draw (0,0.5)--(0,1.5) node[above] {$\atomlegindexof{a}$}; 
...
\draw (3,0.5)--(3,1.5) node[above] {$\atomlegindexof{b}$}; 
...
\draw (6,0.5)--(6,1.5) node[above] {$\atomlegindexof{c}$}; 
