...
\draw[->-] (1.5,-3) --(1.5,-4.5) node[midway,right]{\colorlabelsize $\catvariableof{a \lor b}$};
...
\draw[->-] (6,-3) --(6,-4.5) node[midway,right]{\colorlabelsize $\catvariableof{\lnot c}$};
...
\draw[-<-] (4,-9.5) -- (4,-8) node[midway,right] {\colorlabelsize $\catvariableof{a \lor b \lor \lnot c}$};
