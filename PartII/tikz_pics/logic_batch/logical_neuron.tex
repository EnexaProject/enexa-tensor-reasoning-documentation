...
\node[anchor=center] (text) at (-3,6) {${a)}$};
	...
	\node [circle, draw, thick, fill=gray!50] (ph) at (1.5,3) {\tiny $\catvariableof{\vselectionsymbol,0}$};%{\tiny $\placeholderof{0}$};
	\node [circle, draw, thick, fill=gray!50] (sel) at (-1.5,3) {\tiny $\selvariableof{\vselectionsymbol,0}$};
	
	\node [circle, draw, thick, fill=gray!50] (ph2) at (6,3) {\tiny  $\catvariableof{\vselectionsymbol,1}$};	
	...
	\node [circle, draw, thick, fill=gray!50] (head) at (3.25,6) {\tiny $\catvariableof{\lneuron}$};
...
\draw[->] (1.5,4.5)--(1.5,6) node[midway,right] {\tiny $\catvariableof{\lneuron}$}; %{\tiny $\catvariableof{\placeholderof{0} \placeholderof{1} \placeholderof{2}}$}; 
...
\draw[->] (9,2.5)--(9,3.5) node[midway,left] {\tiny $\catvariableof{\vselectionsymbol,0}$}; 
...
\draw[->] (14,2.5)--(14,3.5) node[midway,left] {\tiny $\catvariableof{\vselectionsymbol,1}$}; 
...
\draw[->] (11.5,5)--(11.5,6) node[midway,left] {\tiny $\catvariableof{\lneuron}$};  %{\tiny $\catvariableof{\placeholderof{0} \placeholderof{1} \placeholderof{2}}$}; 
