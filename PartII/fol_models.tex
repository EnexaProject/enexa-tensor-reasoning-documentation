...
\subsect{Formuly synthesis by connectives}\label{sec:folConnectiveRepresentation}
...
Alternatively, the more direct effective calculus developed in \secref{sec:effectiveCalculus} can be applied and the additional head variables avoided.
...
\begin{theorem}\label{the:reproducingKGSingelObjects}
...
\red{Statistical Models of Knowledge Graphs go beyond the typical single edge type perspective of network science \cite{barabasi_network_2016, giovanni_russo_vito_latora_complex_2017}.}
