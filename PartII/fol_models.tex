...
\begin{assumption}\label{ass:importanceBasemeasure}
...
\begin{assumption}\label{ass:propositionalHeads}
...
\begin{assumption}\label{ass:independentTuples}
...
\begin{proof}
    ...
    We therefore get
    \begin{align}\label{eq:independentSamplesFOL}
        \partitionfunctionof{\folmlnparameters}
        &= \expof{\contraction{\weight} \cdot \contraction{\groundingof{\lnot\impformula}}} \cdot
        \prod_{\datindexin}
        \expectationofwrt{
