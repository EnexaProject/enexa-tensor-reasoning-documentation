...
\begin{align}\label{prob:restrictedNaiveCE}\tag{$\mathrm{P}_{\data,\currentdistribution,\energyhypothesis}$}
	\argmin_{\canparamat{\selvariableof{[\catorder]}}\in\energyhypothesis} \centropyof{\empdistribution}{\expdistof{(\naivestat,\canparam,\currentdistribution)}}
\end{align}
