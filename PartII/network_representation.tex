...
\begin{proof}
	...
	\begin{align*}
		\enumformulaac\left[\indexedcatvariableof{\enumformula}\right]
		= \begin{cases}
			1 & \text{for} \quad \catindexof{\enumformula} = 0 \\
			\expof{\canparamat{\indexedselvariable}} & \text{for} \quad \catindexof{\enumformula}  = 1
		\end{cases}  
	\end{align*}
...
\begin{definition}\label{def:hln}
	...
	Given a set of formulas $\formulaset$, we define the set of hybrid logic networks realizable with $\formulaset$ as
	\begin{align*}
		\hlnsetof{\formulaset} 
