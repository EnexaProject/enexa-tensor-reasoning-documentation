...
\end{proof}
%\red{The face measure is thus}
%\begin{align*}
%    \basemeasureof{\facecondset}
%    = \bigvee_{\meanparam\in\genfaceset\cup\boundaryparcube} \formula^{\meanparam}
%    = \bigvee_{\meanparam\in\genfaceset\cup\boundaryparcube} \bigwedge_{\selindexin} \lnot^{(1-\meanparamat{\indexedselvariable})} \enumformula \, .
%\end{align*}
...
\begin{lemma}\label{lem:minimalContainingFace}
