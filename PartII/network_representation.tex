...
\begin{definition}[\HardLogicNetwork{}]
    ...
    \begin{align*}
        ...
        = \normalizationof{\mlnstatccwith,\hardacttensorwith}{\shortcatvariables}
    \end{align*}
...
%    and for $\selindexin$ boolean vectors $\hardactlegwith$ the \HardLogicNetwork{} is the distribution
%    \begin{align*}
...
%	\begin{align*}
%		\left\{\probofat{\{\kcoreofat{\selindex}\wcols\selindexin\}}{\shortcatvariables} \wcols \hardactlegwith\in\{\tbasisat{\headvariableof{\selindex}},\fbasisat{\headvariableof{\selindex}},\onesat{\headvariableof{\selindex}}\} \right\}
%	\end{align*}
\end{definition}
...
\begin{proof}
    ...
    \begin{align*}
        &\contractionof{\bencodingofat{\mlnstat}{\headvariables,\shortcatvariables},\hardacttensorwith}{\shortcatvariables} \\
        & \quad = \contractionof{
...
%\begin{align*}
%    \hardactlegwith\in\{\tbasisat{\headvariableof{\selindex}},\fbasisat{\headvariableof{\selindex}},\onesat{\headvariableof{\selindex}}\}    \, .
%\end{align*}
...
%%%        \mpfo
%%%    \end{align*}
%%    $\normalizationof{\formulaofat{\{\hardactlegwith\wcols\selindexin\}}{\shortcatvariables}}{\shortcatvariables}$, where
%%    \begin{align*}
%%        \formulaofat{\{\hardactlegwith\wcols\selindexin\}}{\shortcatvariables} =
%%        \left(\bigwedge_{\selindexin\wcols\hardactlegwith=\tbasisat{\headvariableof{\selindex}}} \enumformulaat{\shortcatvariables}\right)
%%        \land
%%        \left(\bigwedge_{\selindexin\wcols\hardactlegwith=\fbasisat{\headvariableof{\selindex}}} \lnot\enumformulaat{\shortcatvariables}\right) \, .
%%    \end{align*}
%\end{theorem}
%\begin{proof}
...
%    We notice, that for each $\selindexin$ the variables $\headvariableof{\selindex}$ appear only in the cores $\bencodingofat{\shortcatvariables}{\headvariableof{\selindex},\shortcatvariables}$ and $\hardactlegwith$ and thus
%    \begin{align*}
%        & \contractionof{
%            \bigcup_{\selindexin}\{\bencodingofat{\enumformula}{\headvariableof{\selindex},\shortcatvariables},\hardactlegwith\}
%        }{\shortcatvariables} \\
...
\begin{theorem}
    ...
    Any distribution $\probwith\in\elrealizabledistsof{\mlnstat}$ is a normalized contraction of a \HardLogicNetwork{} and a \MarkovLogicNetwork{}, that is there are for $\selindexin$ boolean cores $\hardactlegwith$ and a weight vector $\canparamat{\selvariable}$ such that
    \begin{align*}
        \probwith =
        \normalizationof{
...
\begin{definition}[\HybridLogicNetwork{}]
    ...
    \begin{align*}
        \hlnwith
        = \normalizationof{\mlnstatccwith,\paracttensorwith}{\shortcatvariables}
    \end{align*}
...
\begin{proof}
    ...
    \begin{align*}
        \hlnwith
        &= \normalizationof{\mlnstatccwith,\softacttensorwith,\hardacttensorwith}{\shortcatvariables} \\
        &= \normalizationof{\mlnstatccwith,\softacttensorwith,\contractionof{\mlnstatccwith,\hardacttensorwith}{\shortcatvariables}}{\shortcatvariables} \\
        &= \normalizationof{\mlnstatccwith,\softacttensorwith,\hlnformulawith}{\shortcatvariables} \, ,
    \end{align*}
...
%    "$\subset$":\\
%    To any Hybrid Logic Network $\probwith$ in $\elrealizabledistsof{\mlnstat}$ we find by \theref{the:hybridNetworkRepresentation} hard activation cores $\{\hardactlegwith\wcols\selindexin\}$.
%    We build a set
%    \begin{align*}
%        \hardlegset =
%        \left\{\selindex\wcols\hardactlegwith\in\{\fbasisat{\headvariableof{\selindex}},\tbasisat{\headvariableof{\selindex}}\}\right\}
%    \end{align*}
...
%%        \begin{cases}
%%            0 & \ifspace \hardactlegwith=\fbasisat{\headvariableof{\selindex}} \\
%%            0.5 & \ifspace \hardactlegwith=\onesat{\headvariableof{\selindex}} \\
%%            1 & \ifspace \hardactlegwith=\tbasisat{\headvariableof{\selindex}} \\
%%        \end{cases}
%%    \end{align*}
...
%        \cup \{\hardactlegwith \wcols \selindexin\}
%        }{\shortcatvariables}
%        &=
%        \left(\bigwedge_{\selindex\in\hardlegset\wcols\headindexof{\selindex}=1} \enumformulaat{\shortcatvariables}\right)
%        \land
