...
\begin{theorem}[Basis encodings for \MarkovLogicNetworks{}]
    ...
    A \MarkovLogicNetwork{} to a set of formulas $\formulaset = \{\enumformula \, : \, \selindexin\}$ is represented as
    \begin{align*}
...
\sect{Polynomial Representation}\label{sec:HLNpolyRepresentation}
