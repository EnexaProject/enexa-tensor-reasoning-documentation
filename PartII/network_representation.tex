...
\subsect{\SelectionSparsity{}}

\SelectionSparsity{} is more flexible than \DecompositionSparsity, since it does not demand identical subformulas, but only an identical decomposition graph.
The limitation of this scheme is that it can only represent weighted sums of the formulas.
An example, where this is useful are the energy tensors of \MarkovLogicNetworks{}, for example for Boltzmann machines.

\subsect{\PolynomialSparsity{}}\label{sec:HLNpolyRepresentation}

%% First occurance of bas+ tensors!
