...
%    and notice that
%    \begin{align*}
%        \normalizationof{\{\bencodingofat{\hlnstat}{\sstatheadvariables,\shortcatvariables}\}
...
%    We say that a mean parameter $\meanparamwith\in\hlnfaceset$ is reproducable by a \HybridLogicNetwork{} in $\elrealizabledistsof{\hlnstat}$, if the minimal face of $\hlnfaceset$, which includes $\meanparamwith$ is an intersection of $\genmeanset$ and a face $\cubeface$ of the cube $\fullparcube$.
%\end{definition}
