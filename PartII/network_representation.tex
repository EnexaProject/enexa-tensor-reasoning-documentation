...
We call this representation scheme the $\land$-symmetry, since we can either represent $\kb$ by instantiation of $\rencodingof{\kb}$, which involves a basis encoding of the conjunction $\land$, or by instantiations of a collection of $\rencodingof{\formula}$.
