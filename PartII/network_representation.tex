...
%            \tbasisat{\headvariableof{\selindex}} & \text{if} \quad \selindex\in\hardlegset \quad \text{and} \quad \headindexof{\selindex}=1 \\
%            \fbasisat{\headvariableof{\selindex}} & \text{if} \quad \selindex\in\hardlegset \quad \text{and} \quad \headindexof{\selindex}=0 \\
%        \end{cases}
%    \end{align*}
