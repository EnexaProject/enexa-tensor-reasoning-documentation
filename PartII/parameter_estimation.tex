...
% 0/1 Polytopes
The mean parameter polytopes are examples of $0/1$-polytopes \cite{ziegler_lectures_1999,gillmann_01-polytopes_2007}, from which a few obvious properties follow.
...
\begin{example}[Sufficient expressivity in cases of atomic formulas]
...
To summarize, for any $\meanparam\in\hlnmeanset$ we have one of the following (see also Figure~\ref{fig:meansetSketch}):
\begin{itemize}
