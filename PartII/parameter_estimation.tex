...
\begin{theorem}
	...
	of all minterms, respectively of all mapterms, the forward mapping are
		%\[ \forwardmapof{\mintermformulaset}: \bigotimes_{\atomenumeratorin}\rr^{2} \rightarrow \bigotimes_{\atomenumeratorin}\rr^{2} \]
	...
	Possible choices of the backward mappings are
		%\[ \backwardmapof{\mlnmintermsymbol}: \bigotimes_{\atomenumeratorin}\rr^{2} \rightarrow \bigotimes_{\atomenumeratorin}\rr^{2} \]
...
\begin{proof}
	...
	%	\[ \backwardmapof{\mlnmintermsymbol}( \forwardmapof{\mlnmintermsymbol}(\canparam) ) = \canparam - \contractionof{\expof{\canparam}}{\varnothing} \cdot \onesat{\shortcatvariables}
	%	\]
%	and thus $\canparam$ and $\backwardmapof{\mintermformulaset}( \forwardmapof{\mintermformulaset}(\canparam) )$ are representing the same member of the exponential family (see Theorem~\ref{the:tensorRepUniqueness}).	
...
%		\[  \forwardmapof{\mlnatomsymbol}(\canparam_0,\ldots,\canparam_{\atomorder-1}) = \left(\frac{\canparam_0}{1+\canparam_0},\ldots,\frac{\canparam_{\atomorder-1}}{1+\canparam_{\atomorder-1}}\right) \, . \]  %! 
...
%		\[  \backwardmapof{\mlnatomsymbol}(\meanparam_0,\ldots,\meanparam_{\atomorder-1}) = \left(\lnof{\frac{\meanparam_0}{1-\meanparam_0}},\ldots,\lnof{\frac{\meanparam_0}{1-\meanparam_0}}\right) \, . \] 
\end{theorem}
\begin{proof}
...
%	\begin{align*}
%	 	 \forwardmapof{\mlnatomsymbol}(\canparam) 
%		&= \normationofwrt{
