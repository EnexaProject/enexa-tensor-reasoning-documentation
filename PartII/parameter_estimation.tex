...
\begin{theorem}
	Let $\meanparamat{\selvariable} = \contractionof{\probtensor,\sencfset}{\selvariable}$ and
		...
		\, . \]
	The solution of the M-projection of $\probtensor$ onto the set of hybrid logic networks representable by $\formulaset$ then coincides with the projection of $\probtensor$ onto $\expframilyof{\formulaset/\secformulaset,\basemeasureof{\secformulaset,\meanparam}}$.
\end{theorem}
\begin{proof}
